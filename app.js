    ...
    // ?? direkt danach geht's bei dir weiter mit:
    // initializeDefaults() { ... },
    // generateId() { ... },
    // getProject(id) { ... },
    // usw...
            ...
            initializeDefaults() {
                ...
                // Demo members and projects are now loaded via "Demo-Daten laden" button
                // No automatic demo data creation

                // Removed: Auto-create demo members and projects
                // eslint-disable-next-line no-constant-condition
                if (false) {
                    // ============================================================
                    // DEMO-DATEN: 18 RESSOURCEN IN 5 KOMPETENZGRUPPEN
                    // ============================================================

                    // Produktsupport (4 Personen)
                    const ps1 = this.generateId();
                    this.members.push({
                        id: ps1,
                        name: 'Sarah Fischer',
                        role: 'Produktsupport Spezialistin',
                        competencyGroup: 'Produktsupport',
                    ...
                    const ps2 = this.generateId();
                    this.members.push({
                        id: ps2,
                        name: 'Michael Berger',
                        role: 'Customer Application Engineer',
                        competencyGroup: 'Produktsupport',
                        hourlyRateInternal: 88,
                        employmentLevel: 80,
                    ...
                    // Entwicklung Mechanik (4 Personen)
                    const em1 = this.generateId();
                    this.members.push({
                        id: em1,
                        name: 'Thomas Meier',
                        role: 'Senior Mechanik-Ingenieur',
                        competencyGroup: 'Entwicklung Mechanik',
                        hourlyRateInternal: 88,
                        employmentLevel: 100,
                        availableCapacity: 80,
                        active: true,
                    ...
                    const em2 = this.generateId();
                    this.members.push({
                        id: em2,
                        name: 'Julia Schneider',
                        role: 'CAD-Konstrukteurin',
                        competencyGroup: 'Entwicklung Mechanik',
                        hourlyRateInternal: 88,
                        employmentLevel: 80,
                        availableCapacity: 64,
                    ...
                    const em3 = this.generateId();
                    this.members.push({
                        id: em3,
                        name: 'Andreas Hofmann',
                        role: 'Mechanik Lead Engineer',
                        competencyGroup: 'Entwicklung Mechanik',
                        hourlyRateInternal: 88,
                        employmentLevel: 100,
                        availableCapacity: 80,
                    ...
                    const em4 = this.generateId();
                    this.members.push({
                        id: em4,
                        name: 'Nina Bauer',
                        role: 'Mechanik-Entwicklerin',
                        competencyGroup: 'Entwicklung Mechanik',
                        hourlyRateInternal: 88,
                        employmentLevel: 100,
                        availableCapacity: 80,
                    ...
                    // Entwicklung Elektronik (3 Personen)
                    const ee1 = this.generateId();
                    this.members.push({
                        id: ee1,
                        name: 'Stefan Weber',
                        role: 'Senior Elektronik-Ingenieur',
                        competencyGroup: 'Entwicklung Elektronik',
                        hourlyRateInternal: 88,
                        employmentLevel: 100,
                        availableCapacity: 80,
                        active: true,
                    ...
                    const ee2 = this.generateId();
                    this.members.push({
                        id: ee2,
                        name: 'Petra Wagner',
                        role: 'PCB-Design Spezialistin',
                        competencyGroup: 'Entwicklung Elektronik',
                        hourlyRateInternal: 88,
                        employmentLevel: 80,
                        availableCapacity: 64,
                    ...
                    // Verfahrenstechnik (4 Personen)
                    const vt1 = this.generateId();
                    this.members.push({
                        id: vt1,
                        name: 'Robert Huber',
                        role: 'Verfahrenstechnik Lead',
                    ...
                    const vt4 = this.generateId();
                    this.members.push({
                        id: vt4,
                        name: 'Sabine Lehmann',
                        role: 'Fertigungsplanerin',
                        competencyGroup: 'Verfahrenstechnik',
                        hourlyRateInternal: 88,
                        employmentLevel: 60,
                        availableCapacity: 48,
                    ...
                    // Labor (3 Personen)
                    const lb1 = this.generateId();
                    this.members.push({
                        id: lb1,
                        name: 'Daniel Schmidt',
                        role: 'Labor-Ingenieur',
                    ...
                    const lb2 = this.generateId();
                    this.members.push({
                        id: lb2,
                        name: 'Anna Graf',
                        role: 'Test & Validierung',
                        competencyGroup: 'Labor',
                        hourlyRateInternal: 88,
                        employmentLevel: 80,
                        availableCapacity: 64,
                    ...
                    // ============================================================
                    // DEMO-DATEN: 10 PROJEKTE MIT UNTERSCHIEDLICHEN EIGENSCHAFTEN
                    // ============================================================
                    ...
                    if (this.projects.length === 0) {
                        ...
                        this.projects.push({
                            ...
                            budget: {
                                ...
                                total: 450000,
                                forecastExtern: 52000,
                                forecastInvestitionen: 135000,
                                forecastHistory: []
                            }
                        });

                        // PROJEKT 2: Miniatur-Drucksensor (Klein, mittlere Prio, Gate 3)
                        const p2 = this.generateId();
                        this.projects.push({
                            id: p2,
                            ...
                            budget: {
                                ...
                                investitionen: 28000,
                                total: 125000,
                                forecastExtern: 15000,
                                forecastInvestitionen: 32000,
                                forecastHistory: []
                            }
                        });

                        // PROJEKT 3: IoT-Gateway-Modul (Mittel, hohe Prio, Gate 3)
                        const p3 = this.generateId();
                        this.projects.push({
                            id: p3,
                            ...
                            budget: {
                                ...
                                investitionen: 52000,
                                total: 225000,
                                forecastExtern: 32000,
                                forecastInvestitionen: 58000,
                                forecastHistory: []
                            }
                        });
                        ...
                        this.projects.push({
                            ...
                            budget: {
                                intern: 385000,
                                extern: 65000,
                                investitionen: 180000,
                                total: 630000,
                                forecastExtern: 75000,
                                forecastInvestitionen: 195000,
                                forecastHistory: []
                            }
                        });

                        // PROJEKT 5: Kalibrierstation V3 (Mittel, mittlere Prio, Gate 5)
                        const p5 = this.generateId();
                        this.projects.push({
                            id: p5,
                            ...
                            budget: {
                                ...
                                investitionen: 95000,
                                total: 240000,
                                forecastExtern: 38000,
                                forecastInvestitionen: 98000,
                                forecastHistory: []
                            }
                        });

                        // PROJEKT 6: Temperatur-Kompensationsmodul (Klein, niedrige Prio, Gate 3)
                        const p6 = this.generateId();
                        this.projects.push({
                            id: p6,
                            ...
                            budget: {
                                ...
                                total: 65000,
                                forecastExtern: 9500,
                                forecastInvestitionen: 16000,
                                forecastHistory: []
                            }
                        });

                        // PROJEKT 7: Diagnose-Software DiagPro 2.0 (Mittel, hohe Prio, Gate 4)
                        const p7 = this.generateId();
                        this.projects.push({
                            id: p7,
                            name: 'Diagnose-Software DiagPro 2.0',
                            ...
                            budget: {
                                ...
                                investitionen: 25000,
                                total: 195000,
                                forecastExtern: 48000,
                                forecastInvestitionen: 28000,
                                forecastHistory: []
                            }
                        });
                        ...
                        this.projects.push({
                            ...
                            budget: {
                                intern: 420000,
                                extern: 85000,
                                investitionen: 240000,
                                total: 745000,
                                forecastExtern: 95000,
                                forecastInvestitionen: 260000,
                                forecastHistory: []
                            }
                        });

                        // PROJEKT 10: Support-Tool-Suite STS-Pro (Klein, mittlere Prio, Gate 4)
                        const p10 = this.generateId();
                        this.projects.push({
                            id: p10,
                            ...
                            budget: {
                                ...
                                investitionen: 8000,
                                total: 78000,
                                forecastExtern: 21000,
                                forecastInvestitionen: 10000,
                                forecastHistory: []
                            }
                        });
